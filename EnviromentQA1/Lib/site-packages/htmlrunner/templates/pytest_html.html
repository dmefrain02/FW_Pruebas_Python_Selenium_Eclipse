...
function filter_table(elem) {
    ...
    <h1>{{title}}</h1>
    <p>Report generated on {{end_at}} by <a href="https://pypi.python.org/pypi/reportz">reportz</a></p>
    <h2>Environment</h2>
    <table id="environment">
      ...
      <tr>
        <td>Plugins</td>
        <td>{&apos;xdist&apos;: &apos;1.30.0&apos;, &apos;variables&apos;: &apos;1.9.0&apos;, &apos;html&apos;: &apos;2.0.0&apos;, &apos;base-url&apos;: &apos;1.4.1&apos;, &apos;rerunfailures&apos;: &apos;7.0&apos;, &apos;check&apos;: &apos;0.3.5&apos;, &apos;selenium&apos;: &apos;1.17.0&apos;, &apos;forked&apos;: &apos;1.1.3&apos;, &apos;metadata&apos;: &apos;1.8.0&apos;}</td></tr>
      <tr>
        <td>Python</td>
        <td>{{python_version}}</td></tr></table>
    <h2>Summary</h2>
    <p>{{test_cases|length}} tests ran in {{duration}} seconds. </p>
    ...
    <span class="passed">{{pass_num}} passed</span>, 
    ...
    <span class="skipped">{{skipped_num}} skipped</span>, 
    ...
    <span class="failed">{{fail_num}} failed</span>, 
    ...
    <span class="error">{{error_num}} errors</span>, 
    ...
    <span class="xfailed">{{xfail_num}} expected failures</span>, 
    ...
    <span class="xpassed">{{xpass_num}} unexpected passes</span>, 
    ...
    <table id="results-table">
      <thead id="results-table-head">
       ...
       {% for case in test_cases%}
          ...
          {% elif case.status in ['FAIL', 'XPASS'] %}failed
        ...
        <tr>
          <td class="extra" colspan="4">
            <div class="log">{{case.exec_info}}<br/></div></td></tr></tbody>
        {% endfor %}
</table></body></html>