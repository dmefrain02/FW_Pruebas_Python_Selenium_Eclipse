    ...
    def test_001(self):
        ...
        with allure.step(u'Paso 4: Escribir en elemento obtenido de la aplicacion web'):
            try: 
                ...
                Selenium.escribir_texto(self,'TxtCampoBusquedaMercadoLibre', Selenium.pyodbc_ConsultaBD(self, 'select Valor_Dato_Prueba from Datos_Pruebas DP WHERE Id_Prueba = 4'))
